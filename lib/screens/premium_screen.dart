    ...
    return ListView(
      ...
      children: [
        const SectionIntro(
          ...
          body:
              'Unlock the full power of Veltrix with advanced analytics, expert plans and connected coaching.',
        ),
        ...
        const ResponsiveCards(
          children: [
            _PremiumFeature(
              ...
              body:
                  'Build your season with the Annual Training Plan. Drag, drop and adjust workouts with a clear long-range view.',
            ),
            _PremiumFeature(
              ...
              body:
                  'Real-time fitness score, fatigue and form tracking. See how every session contributes to your peak.',
            ),
            _PremiumFeature(
              ...
              body:
                  'Guided strength workouts, health metrics and Fueling Insights to complement your endurance training.',
            ),
          ],
        ),
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Semantics(
                label: 'Subscribe to Premium now',
                button: true,
                child: FilledButton(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                period,
                style: TextStyle(
                  color: featured ? Colors.white70 : muted,
                  fontSize: 14,
                ),
              ),
            ],
          ...
          Text(
            detail,
            style: TextStyle(
              color: featured ? Colors.white60 : muted,
              fontSize: 12,
            ),
          ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      f,
                      style: TextStyle(
                        color: featured ? Colors.white70 : ink,
                        fontSize: 13,
                      ),
                    ),
                  ),
          ...
          Semantics(
            label: 'Get Started with $plan plan, $price per month',
            button: true,
            child: FilledButton(
              style: FilledButton.styleFrom(
  ...
  Widget build(BuildContext context) {
    ...
    const features = [
      (
        Icons.show_chart,
        'PMC Chart',
        'Track fitness, fatigue and form over time with the Performance Management Chart.',
      ),
      (
        Icons.library_books,
        'Workout Library',
        'Drag-and-drop workout builder with structured workout templates.',
      ),
      (
        Icons.chat_bubble_outline,
        'Enhanced Coaching',
        'Real-time notifications, availability status and detailed workout notes.',
      ),
      (
        Icons.restaurant,
        'Fueling Insights',
        'Track nutrition and fueling strategies aligned with your training load.',
      ),
    ];
    return Column(
      children: [
