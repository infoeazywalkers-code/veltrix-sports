              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: (Theme.of(context).brightness == Brightness.dark ? const Color(0xFF78909C) : muted), fontSize: 16),
                  ),
                ],
              ),
            );
          ...
          if (athletes.isEmpty) {
            return Center(
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.people_outline, size: 64, color: (Theme.of(context).brightness == Brightness.dark ? const Color(0xFF78909C) : muted)),
                  ...
                  Text(
                    ...
                    style: TextStyle(color: (Theme.of(context).brightness == Brightness.dark ? const Color(0xFF78909C) : muted), fontSize: 14),
                  ),
                ],
              ),
            );
          ...
          child: Row(
            children: [
              CircleAvatar(
                ...
                child:
                    athlete.photoUrl == null
                        ? Icon(Icons.person, color: (Theme.of(context).brightness == Brightness.dark ? Colors.white : navy), size: 24)
                        : null,
              ),
              ...
              PopupMenuButton<String>(
                icon: Icon(Icons.more_vert, color: (Theme.of(context).brightness == Brightness.dark ? const Color(0xFF78909C) : muted)),
