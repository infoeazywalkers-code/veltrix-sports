          ...
          child: Column(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: _getZoneColor(_engine.currentZone).withValues(alpha: 0.2),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(color: _getZoneColor(_engine.currentZone)),
              ),
              child: Row(
            ...
            if (_engine.isBleConnected) ...[
              ...
              Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    const Icon(Icons.bluetooth_connected, color: Colors.green, size: 14),
                    ...
                    return Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(lap.duration, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w900)),
                          Text(lap.pace, style: const TextStyle(color: lime, fontWeight: FontWeight.w700)),
                        ],
                      ),
                    );
                  },
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      height: 72,
                      decoration: BoxDecoration(
                        color: _engine.state == WorkoutExecutionState.running ? Colors.orange : lime,
                        shape: BoxShape.circle,
                      ),
                      child: Icon(
                    ...
                    IconButton.filledTonal(
                      ...
                      onPressed: () async {
                        ...
                        if (context.mounted) {
                          ...
                          showFeatureMessage(context, 'Workout completed & saved!');
                        }
                      },
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            label,
            style: const TextStyle(color: Colors.white60, fontSize: 10, letterSpacing: 1.2, fontWeight: FontWeight.w900),
          ),
