...
class _ProfileEditScreenState extends ConsumerState<ProfileEditScreen> {
  ...
  void _initFromData(UserProfile? profile, UserPreferences? prefs) {
    ...
    _selectedPrimarySport =
        profile.sports.isNotEmpty ? profile.sports.first : 'Running';
    ...
    final picked = await showDatePicker(
      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(
            context,
          ).copyWith(colorScheme: ColorScheme.light(primary: navy)),
          child: child!,
        );
      },
    );
          ...
          children: [
            ...
            _buildCard([
              ...
              TextFormField(
                ...
                ).copyWith(fillColor: const Color(0xffeef1f5), filled: true),
            ...
            _buildCard([
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.cake_outlined, color: navy, size: 22),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                fontWeight: FontWeight.w600,
                                color: _dateOfBirth != null ? navy : muted,
                                fontSize: 15,
                              ),
                            ),
                          ],
