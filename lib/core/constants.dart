...
/// Width below which the app uses the mobile shell ([MobileShell]).
/// Desktop shell ([Shell]) uses 1050 elsewhere; marketing sections use 850.
/// Those values are intentionally left untouched.
const kMobileBreakpoint = 900.0;
